            ...
            <section className="bg-gray-50 py-24">
                <div className="container mx-auto px-4 grid md:grid-cols-2 gap-10 max-w-6xl">
                    ...
                    {[
                        ...
                        <div className="bg-white p-0  rounded-3xl  border  transition-all  duration-300  hover:-translate-y-1  [box-shadow:0_4px_6px_rgba(0,0,0,0.1)] hover:[box-shadow:0_18px_38px_rgba(153,0,0,0.22)]
">                            <img src={images[i]} alt={item.title} className="w-full h-40 object-cover rounded-t-2xl mb-3 " />
            ...
            {/* VALUES */}
            <section className="py-24 bg-gradient-to-br from-white via-red-50/60 to-white ">
                ...
                <div className="container mx-auto px-4 grid md:grid-cols-4 gap-6 max-w-6xl  ">
                    {universityInfo.values.map((v, i) => (
                        <div
                            className="p-6 relative overflow-hidden rounded-2xl border bg-white text-center shadow-sm hover:-translate-y-2 transition-all duration-300"
                        >
